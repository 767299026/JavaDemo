...
import com.lsl.security.exception.OAuthClientException;
...
public class TokenController {
    ...
    private final AuthenticationFailureHandler authenticationFailureHandler = new LoginFailureHandler();
    ...
    public R<Boolean> removeToken(@PathVariable("token") String token) {
        ...
        // 清空用户信息
        cacheManager.getCache(CacheConstant.USER_DETAILS).evict(authorization.getPrincipalName());
        // 清空access token
    ...
    public R<Page> tokenList(@RequestBody Map<String, Object> params) {
        ...
        int current = MapUtil.getInt(params, Constant.CURRENT);
        int size = MapUtil.getInt(params, Constant.SIZE);
